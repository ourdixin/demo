xh5_define("datas.k", ["utils.util"], function (e) {
    ...
    function () {
            ...
            var l = function () {
                ...
                i = function (t, s, o) {
                    ...
                    if (s && s.date) {
                            var b, d = s.date,
                                h = !1;
                            if (t.length > 0 ? (b = t[t.length - 1], d || (d = b.date)) : h = !0, b) if ("NF" === u || "GOODS" === u) n.stbd(b.date, d) ? 1 != s.iscff && s.withNight && s.time >= i ? h = !0 : s.open && s.price && (b.open = s.open, b.high = s.high, b.low = s.low, b.close = s.price, b.volume = s.totalVolume * c) : d < b.date || (h = !0);
                            else if (n.stbd(b.date, d))"hf_CHA50CFD" === s.symbol && s.time >= i ? h = !0 : s.date && s.open && s.price && (b.open = s.open, b.high = s.high, b.low = s.low, b.close = s.price, b.volume = s.totalVolume * c, b.date = n.ddt(d), b.postAmt = s.postAmount, b.postVol = s.postVolume * c);
                            else if (d < b.date);
                            else if (i) if ("hf_CHA50CFD" === s.symbol) h = !0;
                            else if (s.time >= i) h = !0;
                            else {
                                    var f = (d - b.date) / 1e3 / 24 / 60 / 60;
                                    h = f >= 2
                                } else h = !0;
                            if (h) {
                                    var _ = s.totalVolume * c;
                                    t.push({
                                        open: s.open,
                                        high: s.high,
                                        low: s.low,
                    ...
                    var y = !isNaN(p) && p > 0 ? p : t[0].open;
                    e.oc(t[0], {
                            prevclose: y,
                            name: m,
                            symbol: l
                        });
                    var v = a.mw(t, s, y, c, r.endDay),
                        g = v[0],
                        k = v[1],
                        w = v[2],
                        N = void 0;
                    if (a.pd(t, null), a.pd(g, null), a.pd(k, null), a.pd(w, null), s && s.settlement) {
                            var $ = t[t.length - 1];
                ...
                u = function (t, n) {
                    ...
                    return r[l] && (a = r[l].DAYK_RE_URL, s = r[l].RE_VAR),
                    a && (o || n) && (a = e.getSUrl(a)),
                    {
                        url: a,
                        VAR: s,
                ...
                p = function (t, n) {
                    ...
                    return r[i] && (a = r[i].INIT_URL, s = r[i].INIT_VAR, l = r[i].INIT_VAR_PRE),
                    a && (o || n) && (a = e.getSUrl(a)),
                    {
                        url: a,
                        VAR: s,
                ...
                m = {
                    xh5Fund: function (e) {
                        for (var t, n, a, s, o = new Date, r = [o.getFullYear(), o.getMonth() + 1, o.getDate()].join("_"), l = e.data, i = e.symbol, c = l.split("#"), u = [], p = [], m = [], b = [], d = [], h = [], f = c.length; f--;) s = c[f].split(","),
                        t = s[0].slice(0, 4),
                        n = s[0].slice(4, 6),
                        a = s[0].slice(6, 8),
                        a = [t, n, a].join("-"),
                        ...
                        var _ = ["_dwjz_", i, r].join(""),
                            y = ["_ljjz_", i, r].join(""),
                            v = ["_lshb_", i, r].join(""),
                            g = ["_pwbfbyd_", i, r].join(""),
                            k = ["_pwbfbjd_", i, r].join(""),
                            w = ["_pwbfbnd_", i, r].join(""),
                            N = ["_fh_", i, r].join("");
                        window[_] = u,
                        window[y] = p,
                        window[v] = m,
                ...
                b = function (e) {
                    var t = [];
                    if (e) for (var n, a, s = 0, o = e.length; o > s; s++) {
                        a = e[s],
                        n = Number(a.c);
                        var r = a.d.split("-");
                        t.push({
                ...
                d = function (e) {
                    var t = [];
                    if (e) for (var n, a, s = e.split("|"), o = 0, r = s.length; r > o; o++) n = s[o].split(","),
                    n.length < 5 || (a = n[0].split("-"), t.push({
                        open: Number(n[1]),
                        low: Number(n[2]),
                        high: Number(n[3]),
                        close: Number(n[4]),
                ...
                h = function (e) {
                    var t = [];
                    if (e && e.result && e.result.data) for (var n, a, s = e.result.data, o = s.split("|"), r = 0, l = o.length; l > r; r++) n = o[r].split(","),
                    n.length < 5 || (a = n[0].split("-"), t.push({
                        open: Number(n[1]),
                        low: Number(n[2]),
                        high: Number(n[3]),
                ...
                f = function (e) {
                    var t = [];
                    if (e && e.length) for (var n, a, s = .001, o = e.split("|"), r = 0, l = 0, i = o.length; i > l; l++) n = o[l].split(","),
                    n.length < 5 || (a = n[0].split("-"), r = Number(n[4]) || r, t.push({
                        open: Number(n[1]) || r,
                        low: Number(n[2]) || r,
                        high: Number(n[3]) || r,
                        close: Number(n[4]) || r,
                ...
                _ = function (e) {
                    var t = [];
                    if (e) for (var n, a, s, o = 0, r = e.length; r > o; o++) n = e[o],
                    a = n[0].split("-"),
                    s = Number(n[4]),
                    t.push({
                        date: new Date(Number(a[0]), Number(a[1]) - 1, Number(a[2]), 0),
                ...
                y = function (e) {
                    var t = [];
                    if (e) for (var n, a, s = e.length; s--;) n = e[s],
                    a = Number(n[4]),
                    t.push({
                        day: n[0],
                        open: Number(n[1]) || a,
                ...
                v = function (e) {
                    var t = [];
                    if (e) for (var a, s, o = 0, r = e.length; r > o; o++) a = e[o],
                    s = Number(a.close),
                    t.push({
                        date: n.sd(a.date),
                ...
                g = function (e, t) {
                    if (!e) return null;
                    for (var n, a = t.vu || 1, s = 0, o = e.length; o > s; s++) n = e[s],
                    n.high *= 1,
                    n.open *= 1,
                    n.low *= 1,
                    n.close *= 1,
                ...
                k = function (e) {
                    if (!e) return null;
                    for (var t, a = 0, s = e.length; s > a; a++) t = e[a],
                    t.high = 1 * t.h,
                    t.open = 1 * t.o,
                    t.low = 1 * t.l,
                    t.close = 1 * t.c,
                ...
                N = function (t, a, s, o) {
                    for (var r, l, i = e.market(o.hqSb), c = "BTC" == i ? 0 : ("DINIW" == o.hqSb, 6), u = a.length; u-- && 0 != u;) for (var p = a[u], m = a[u - 1], b = n.ssd(p.day), d = n.ssd(m.day), h = u; d.setMinutes(d.getMinutes() + s) < b;) {
                        if (r = d.getDay(), 6 == r) {
                            if (l = d.getHours(), l >= c) continue
                        } else {
                            if (0 == r) continue;
                            if (1 == r && (l = d.getHours(), c > l)) continue
                        }
                        var f = e.clone(m, null);
                        f.day = n.dss(d),
                        a.splice(h++, 0, f)
                    }
                    for (var _ = a[a.length - 1], y = n.ssd(_.day); y.setMinutes(y.getMinutes() + s) < t;) {
                        if (r = y.getDay(), 6 == r) {
                            if (l = y.getHours(), l >= c) continue
                        } else {
                            if (0 == r) continue;
                            if (1 == r && (l = y.getHours(), c > l)) continue
                        }
                        var v = {
                            open: _.close,
                            high: _.close,
                ...
                $ = function (t, a, s) {
                    ...
                    if (n.stbds(t.date, i, null)) {
                            var c, u, p, m = t.prevclose,
                                b = t.date.getHours();
                            if (r > b) {
                                    var d, h = !1;
                                    for (c = a.length; c-- && (d = !1, p = a[c], u = Number(p.day.split(" ")[1].split(":")[0]), !h && r > u ? d = !0 : u >= r && (h = !0, d = !0), d);) p.prevclose = m
                                } else for (c = a.length; c-- && (p = a[c], u = Number(p.day.split(" ")[1].split(":")[0]), u >= r);) p.prevclose = m
                        }
                },
                D = function (t, a) {
                    if (!t) return null;
                    var s, o, r = Number(a.scale),
                        l = e.market(a.hqSb);
                    a.hqObjs && (s = a.hqObjs[a.hqSb], o = new Date(1e3 * a.hqObjs[a.withsymbol].hqstr)),
                    o || (o = new Date);
                    var i = 60 * o.getTimezoneOffset() * 1e3;
                    o.setTime(o.getTime() + i),
                    o.setHours(o.getHours() + 8);
                    for (var c, u, p = 0, m = t.length; m > p; p++) if (u = t[p], u.high = 1 * u.h, u.open = 1 * u.o, u.low = 1 * u.l, u.close = 1 * u.c, "BTC" == l && (u.volume = 1 * u.v), r > 1) {
                            var b = n.ssd(u.d);
                ...
                R = function (e, t) {
                    return e && e.result && e.result.data ? (e = e.result.data, D(e, t)) : null
                },
                K = function (t) {
                    var n, a = t.symbol,
                        s = t.volunit || 1,
                        o = e.market(a),
                        l = !1;
                    t.dataurl && t.dataurl.length > 1 ? n = t.dataurl : (/^(CN|HK|US|REPO|MSCI)/.test(o) && (l = !0), e.isCNK(t.symbol) && (l = !1, r.CN.DAYK_URL = r.CNKCB.DAYK_URL), n = c(a, !! t.ismink, t.ssl));
                    var i, u, p, m = a,
                        g = a;
                    switch (o) {
                        case "HK":
                    ...
                    var o = K(n),
                        r = function (r) {
                            var c = r ? r.data[0] : void 0,
                                ...
                                d = "_" + o.kSb.replace(/\W/g, "") + m,
                                h = "MSCI" === o.market ? "K2_" : "KL_";
                            if (0 === window.RELOAD_DK_DATA) {
                                    if (window.RELOAD_DK_SYMBOL === o.kSb) return
                                } else window.RELOAD_DK_DATA = 0,
                            window.RELOAD_DK_SYMBOL = o.kSb;
                            t(o.kUrl.replace("$symbol", o.kSb).replace("$rn", m).replace("$cb", "var%20" + d + "="), function () {
                                    var t;
                                    if (o.isCompressData) {
                                        var r = o.kSb.replace(".", "$");
                                        t = window["KLC_" + h + r],
            ...
            this.get = function (t, n) {
                    t.staticdata ? A(t, n) : (t.wfn && e.isFunc(m[t.wfn]) && (window[t.wfn] = m[t.wfn]), t.ismink ? S(t, n) : L(t, n))
                },
            ...
            this.loadHFInit = function (n, a) {
                    var s = l(),
                        ...
                        u = c + o,
                        m = window[u];
                    m ? (s.data = m, e.isFunc(a) && a(s)) : (o = o.split("hf_")[1], t(i.replace("$cb", "var%20" + u + "=").replace("$symbol", o), function () {
                            m = window[u],
                            m ? s.data = m : (window[u] = null, s.msg = "error, illegal data"),
                            e.isFunc(a) && a(s)
                        }, function () {
                            s.msg = "error",
                            e.isFunc(a) && a(s)
            ...
            this.loadNFInit = function (n, a) {
                    var s = l(),
                        ...
                        u = c + o,
                        m = window[u];
                    m ? (s.data = m, e.isFunc(a) && a(s)) : (o = o.match(/^nf_([a-zA-Z]+)\d+$/)[1], t(i.replace("$cb", "var%20" + u + "=").replace("$symbol", o), function () {
                            m = window[u],
                            m ? s.data = m : (window[u] = null, s.msg = "error, illegal data"),
                            e.isFunc(a) && a(s)
                        }, function () {
            ...
            this.loadGBInit = function (n, a) {
                    var s = l(),
                        ...
                        u = c + o,
                        m = window[u];
                    m ? (s.data = m, e.isFunc(a) && a(s)) : (o = o.split("znb_")[1], t(i.replace("$cb", "var%20" + u + "=").replace("$symbol", o), function () {
                            m = window[u],
                            m ? s.data = m : (window[u] = null, s.msg = "error, illegal data"),
                            e.isFunc(a) && a(s)
                        }, function () {
...
xh5_define("chart.h5k", ["cfgs.settinger", "utils.util", "utils.painter"], function (e, t, n) {
    ...
    function a(a) {
        function i(e, n) {
            ...
            function l(e, t) {
                var n, a, i = R.get(_.URLHASH.KD),
                    o = i.length;
                e || (n = 0),
                t || (a = o - 1);
                for (var s = 0; o > s && (isNaN(n) && i[s].date >= e && (n = s), isNaN(a) && i[s].date >= t && (a = s), isNaN(n) || isNaN(a)); s++);
                return [n, a]
            }
            function c() {
                n && (K = R),
            ...
            function () {
                    var i, o = {},
                        ...
                        r = function (e, a, s, r, l) {
                            if (a) {
                                if (n) {
                                    if (e == _.URLHASH.KD && (i = t.clone(a, null)), r && window.datelist && h.hq) {
                                        var c = t.xh5_S_KLC_D(window.datelist);
                                        a = t.kUtil.ayd(a, c, !1, a[0].date, h.hq.date)
                                    }
                                } else l || (e == _.URLHASH.KD && (i = t.clone(a, null)), a = t.kUtil.adbd(a, K.get(e), s, !1));
                                o["k" + e] = a;
                                var d = a.length,
                    ...
                    this.initExtraData = function () {
                            ...
                            t.load(n.replace("$symbol", e.symbol).replace("$rn", String((new Date).getDate())).replace("$cb", "var%20" + i + "="), function () {
                                var e = window[i];
                                if (e) {
                                    for (var t, n = [], a = e.length; a--;) t = e[a],
                                    n.push({
            ...
            function () {
                    var e = function () {
                        ...
                        t = function () {
                            for (var e, t = 0, n = h.dataLen; n > t; t++) e = h.datas[t],
                            e.close <= 0 || (e.high > h.maxPrice && (h.maxPrice = h.rangeMax = e.high), e.low < h.minPrice && (h.minPrice = h.rangeMin = e.low), h.maxVolume = Math.max(h.maxVolume, e.volume));
                    ...
                    this.createPlayingData = function () {
                            var e, t, n = L.DIMENSION.h_k,
                                a = n * L.DIMENSION.P_HV,
                                i = n * (1 - L.DIMENSION.P_HV);
                            e = h.labelMinP,
                            t = h.labelMaxP;
                            for (var o, s = h.labelMaxVol, r = h.prevclose, l = h.isTotalRedraw ? 0 : h.dataLen - h.dataLenOffset, c = L.custom.show_underlay_vol, u = h.isCompare ? "ppp" : "pp", p = h.dataLen; p > l; l++) o = h.datas[l],
                            ...
                            if (i) {
                                ...
                                V.end = s;
                                        ...
                                        if (n && s + 1 >= i.length) {
                                            var r = i.length - s;
                                            V.end = s = i.length,
                                            (1 == a.pcm || V.viewId == _.URLHASH.K1) && (0 == o && s > 1 && s < L.PARAM.minCandleNum && (o = s - 1, V.start = o), s - o >= L.PARAM.defaultCandleNum && (o += r, V.start = o))
                                        }
                                        R.set("v", o),
                                        R.set("b", s)
                                    }
                                switch (V.currentLength = s - o, V.startDate = i[o].date, V.endDate = i[s - 1].date, a.pcm) {
                                    case 1:
            ...
            function () {
                    var o, s = function (e) {
                        return o ? (e.volume = e.totalVolume - (o.totalVolume || 0), e.amount = e.volume * e.price) : (o = {}, e.volume = 0),
                        ...
                        l = function (e, n, a) {
                            if (e.isUpdateTime) {
                                ...
                                if (i && !(i.length < 1)) {
                                    ...
                                    if (1 == a) {
                                            if (s.time && !t.kUtil.spk(s.time, e.time, b, n, h.market)) {
                                                if (t.kUtil.nc(i, e, n, {
                                                    price: e.price,
                                                    volume: e.volume
                                                }), /^forex|^BTC/.test(h.market)) n == _.URLHASH.K1 && (s = i[i.length - 1], s.prevclose = e.prevclose, s.change = e.price - e.prevclose, s.percent = s.change / e.prevclose);
                                                else if ("NF" == h.market);
                                        ...
                                        } else if (f(e.date, s.date)) h.nco && ("NF" == h.market ? m.dst(s.date) < h.nco.open && e.time >= h.nco.open && e.time > h.nco.close && t.kUtil.nc(i, e, n, null) : r && e.time >= h.nco.open && (r = !1, t.kUtil.nc(i, e, n, null)));
                                    else {
                                    ...
                                    s.date = m.ddt(e.date),
                                    s.day = m.ds(s.date, "/"),
                                    n == _.URLHASH.KMS ? (s.volume = e.trvolume || 0, s.amount = e.tramount || 0, s.trbs = e.trbs, s.kke_cs = 0 == e.trbs ? -1 : 1) : (o ? (s.open = e.open, s.high = e.high, s.low = e.low, s.volume = e.totalVolume) : isNaN(s.volume) ? s.volume = e.volume : s.volume += Number(e.volume), s.kke_cs = s.close > s.open ? 1 : s.open > s.close ? -1 : 0);
                                    var u;
                                    1 == i.length ? u = o ? e.prevclose : s.open : (u = i[i.length - 2].close, e.settlement && o && (u = e.settlement)),
                                    ...
                                    s.time = e.time,
                                    t.isCNK(e.symbol) && (s.postVol = e.postVolume, s.postAmt = e.postAmount)
                                }
                            }
                        },
                        c = function (e) {
                    ...
                    function () {
                            this.check = function (e) {
                                ...
                                var o = i[i.length - 1];
                                if (e.date > o.date) if ("mink" == _.URLHASH.gt(V.viewId).type) {
                                        if (!t.kUtil.spk(o.time, e.time, "00:00", a, h.market)) return !1
                    ...
                    this.uUpdate = function (n, o, r, l) {
                            ...
                            r ? (u = "datas.hq.parse", p.hqStr = r, p.market = l) : (u = "datas.hq.get", p.delay = !0, p.cancelEtag = o),
                            KKE.api(u, p, function (a) {
                                var o = a.dataObj[e.symbol];
                                if (o && o.date && s(o)) {
                                    if (I = I || o.name || "", !d.check(o)) return;
                                    h.hq = o,
                                    c(o),
                                    i(!0),
                                    t.isFunc(n) && n()
            ...
            function () {
                    var i, o = function (e, n) {
                        ...
                        r = function (e, a, i, o) {
                            if (e) {
                                var s, r, l, c, h, d, u, p, f, v, g, b, y = !(-828 === e),
                                    N = R.getOriDK(),
                                    w = 0;
                                if (r = "q" === i ? _.URLHASH.KDF : _.URLHASH.KDB, R.initState(r, t.clone(N, null), !1, !1, !0), s = R.get(r), b = s.length, y) {
                                        for (g = b - 1; g >= 0; g--) {
                                            for (p = s[g], f = m.ds(p.date); f < a[w].d;) w++;
                                            if (v = Number(a[w].f), "HK" === o) {
                                                if (p.high *= v, p.low *= v, p.open *= v, p.close *= v, "h" === i) {
                                                    var k = Number(a[w].c);
                                                    p.high += k,
                                                    p.low += k,
                                                    p.open += k,
                                                ...
                                                var M = Number(a[w].c) || 0;
                                                p.high = p.high * v + M,
                                                p.low = p.low * v + M,
                                                p.open = p.open * v + M,
                                                p.close = p.close * v + M
                                            } else "h" === i ? (p.high *= v, p.low *= v, p.open *= v, p.close *= v) : (p.high /= v, p.low /= v, p.open /= v, p.close /= v)
                                        }
                                        for (g = 0; b > g; g++) p = s[g],
                                        v = Number(a[a.length - 1].f),
                                        0 == g && (d = p.prevclose, isNaN(d) || 0 >= d ? d = p.open : (d = "HK" === o ? p.prevclose * v : "h" === i ? p.prevclose * v : p.prevclose / v, p.prevclose = d)),
                                ...
                                t.kUtil.pd(c, null),
                                t.kUtil.pd(u, null),
                                R.initState(_.URLHASH["q" == i ? "KWF" : "KWB"], h),
                                R.initState(_.URLHASH["q" == i ? "KMF" : "KMB"], c),
                                R.initState(_.URLHASH["q" == i ? "KYF" : "KYB"], u);
                                var L = t.clone(s, null);
                                R.initState(_.URLHASH["q" == i ? "KCLF" : "KCLB"], L, !1, !0),
                                n || R.initState(r, s)
                            }
                        },
                        l = function (t) {
                        ...
                        c = function (e, t) {
                            var s = _.URLHASH.gt(i),
                                r = "mink" == s.type ? R.initState : R.initDWMState;
                            F.show(),
                            ...
                            KKE.api("datas.k.get", e, function (a) {
                                    ...
                                    if (i = 0 / 0, "error" == a.msg) {
                                        if (h.isErr = !0, n) if (a.data && a.data.hq) {
                                            var c;
                                            if (a.data.hq.status) switch (a.data.hq.status) {
                                            case 2:
                                                c = _.notlisted;
                                                break;
                                            case 3:
                        ...
                        p = function (t) {
                            var n, i, o = V.viewId,
                                s = _.URLHASH.gt(o);
                            if (h.nco && h.nco.open) i = h.nco.open,
                            b = i;
                            else {
                                    var r = new Date,
                                        l = b.split(":");
                            ...
                            if ("mink" == s.type) {
                                    if (n = e.datas.min, d.ismink = !0, d.scale = o, /^forex|^BTC/.test(h.market)) switch (d.withsymbol = "sys_time", o) {
                                    case _.URLHASH.K1:
                                        d.datalen = 1440;
                                        break;
                                    case _.URLHASH.K240:
                        ...
                        g = function (t) {
                            ...
                            KKE.api(i, n, function (e) {
                                    ...
                                    if (n) {
                                        var a = n.time;
                                        a && a.length > 0 && (h.nco.open = a[0][0] || h.nco.open, h.nco.close = a[a.length - 1][1] || h.nco.close)
                                    }
                                    p(t)
                                })
                        },
                        ...
                        N = function (e, t) {
                            ...
                            "rek" == t.type && R.get(_.URLHASH.KD) ? l(e) : p(e)
                        };
                    this.iInit = function (e) {
                            ...
                            if (i != t) {
                                ...
                                case "BTC":
                                    ...
                                    break;
                                default:
                                    "msk" == n.type ? d(e) : "rek" == n.type && R.get(_.URLHASH.KD) ? l(e) : p(e)
                                }
                            }
                        }
                };
            ...
            this.getYtdIndex = function (e) {
                    var t = R.get(_.URLHASH.KD);
                    if (!t) return null;
                    var n = t[t.length - 1],
                        a = n.date.getFullYear(),
                        i = 0;
                    return e && (a--, i = n.date.getMonth()),
                    l(new Date(a, i, 1))
                },
            this.initData = $.iInit,
            ...
            this.initPt = function (e, i) {
                    if (e) {
                        !t.isArr(e) && (e = [e]);
                        for (var o = e.length; o--;) if (e[o].name && "VOLUME" === e[o].name.toUpperCase()) {
                            e.splice(o, 1),
                        ...
                        N || (N = new s({
                            ...
                            type: "k",
                            usrObj: a
                        }), n && (E = N), G && (g = N.showHide(G), G = void 0)),
                        N.createChart(e, i)
                    }
                },
            this.removePt = function (e) {
                    if (e) {
                        !t.isArr(e) && (e = [e]);
                        for (var n = e.length; n--;) if (e[n].name && "VOLUME" === e[n].name.toUpperCase()) {
                            e.splice(n, 1),
            ...
            var o, s, r, l, c, d, u, m = {},
                ...
                N = function (e) {
                    if (o = p({
                        linetype: "solid",
                        linecolor: m
                    }, e || {}), m = o.linecolor, r = m.K_N, s = m.K_FALL, l = m.K_RISE, c = m.K_CL, !o.linetype && (o.linetype = g), L.datas.candle = o.linetype, 0 == o.linetype.indexOf("line") || 0 == o.linetype.indexOf("mountain")) {
                ...
                _ = function (t, n) {
                    ...
                    for (var a, i, o, s = !1, r = !1, l = e.datas, c = l.length; c--;) {
                        if (o = l[c], a = n, !s && o.high == e.rangeMax) {
                            ...
                            99 > a ? u.textAlign = "left" : a > L.DIMENSION.w_k - 99 ? (u.textAlign = "right", a -= 5) : u.textAlign = "center",
                            i = o.hy,
                ...
                k = function () {
                    for (var t, n, a = e.datas, i = a.length, s = L.DIMENSION.w_k / Math.max(i, L.PARAM.minCandleNum), r = z.x - .4 * s, l = 0; i > l; l++) n = a[l],
                    t = n.cy,
                    0 == l ? (d.newStyle(c, !0, f), d.moveTo(r, t)) : d.lineTo(r, t),
                    n.ix = r,
                    r += s;
                    d.stroke(),
                    0 == o.linetype.indexOf("mountain") && (r -= s, d.lineTo(r, L.DIMENSION.h_k), d.lineTo(z.x - .4 * s, L.DIMENSION.h_k), d.newFillStyle_rgba(L.COLOR.M_ARR, L.DIMENSION.h_k, L.COLOR.M_ARR_A), d.fill()),
                ...
                M = function () {
                    for (var t, n, a, i, o = e.datas, c = o.length, h = L.DIMENSION.w_k / Math.max(c, L.PARAM.minCandleNum), u = .6 * h, p = -1, m = 1, f = 0; 3 > f; f++) {
                        ...
                        for (t = z.x - h, d.beginPath(), a = 0; c > a; a++) n = o[a],
                        n.isFake || (n.kke_cs == p && d.drawCandleRect(t, n.oy, n.cy, u, i, n.kke_cs == m), 0 == f && (n.ix = t + u)),
                        t += h;
                        for (d.stroke(), t = z.x - h, d.beginPath(), a = 0; c > a; a++) n = o[a],
                ...
                S = function () {
                    ...
                    for (var p, m = 0; 3 > m; m++) {
                            ...
                            for (t = z.x - c, d.beginPath(), a = 0; o > a; a++) n = i[a],
                            n.isFake || (n.kke_cs == u && d.drawCandleRect_solid(t, n.oy, n.cy, h, p), 0 == m && (n.ix = t + h)),
                            t += c;
                            for (d.stroke(), t = z.x - c, d.beginPath(), a = 0; o > a; a++) n = i[a],
                ...
                A = function () {
                    for (var t, n, a, i, o = e.datas, c = o.length, h = L.DIMENSION.w_k / Math.max(c, L.PARAM.minCandleNum), u = .6 * h, p = -1, m = 0; 3 > m; m++) {
                        ...
                        for (t = z.x - h, d.beginPath(), a = 0; c > a; a++) n = o[a],
                        n.isFake || (0 == m && (n.ix = t + u), n.kke_cs == p && d.drawOhlc(t, n.oy, n.hy, n.ly, n.cy, u, i)),
                        t += h;
                        d.stroke(),
                        p++
                    }
        ...
        function M() {
            var e, n, l, h, d = this,
                ...
                y = function () {
                    ...
                    for (var r, l, c, h, d = s ? "Percent" : "Price", u = o; u--;) e = f[u],
                    a.scalerange ? c = a.scalerange : (h = e.getPriceTech(), s || !h ? c = [i, n] : (t = h && h.getMaxMin(), c = t || [i, n])),
                    r = e["min" + d],
                    l = e["max" + d],
                    isFinite(r) && isFinite(l) && (n = Math.min(n, r, c[1]), i = Math.max(i, l, c[0]));
                    var p;
                ...
                k = function (t) {
                    w();
                    for (var n, a = f.length, i = 0; a > i; i++) n = f[i],
                    n.onViewChange();
                    y(),
                    N(),
                    t || q.onRange(e, a > 1)
                ...
                S = !1,
                A = function (t) {
                    return t.isErr ? (t !== e && d.removeCompare([t.symbol]), !0) : t.kDb.get() ? !0 : (t.initData(C), !1)
                },
                I = function (e) {
                    if (e && t.isFunc(e.callback)) {
                        for (var n = !1, a = M.length; a--;) if (e.callback === M[a]) {
                            n = !0;
                            break
                        }!n && M.push(e.callback)
                    }
                ...
                R = function () {
                    for (var t, n = !0, a = f.length; a--;) t = f[a],
                    t == e || A(t) || (n = !1, S = !0);
                    return n
                },
                C = function (t, n) {
                    if (I(n), A(e)) {
                        ...
                        if (B.patcher.switchFloater(), z.resetX(0), R()) for (S = !1, k(t); M.length;) {
                            var a = M.shift();
                            a()
                        }
                ...
                H = function (e) {
                    (e || V.end == V.dataLength) && (B.update(), y(), N(), D(!0)),
                    q.onDataUpdate(),
                    !B.isIng() && q.onViewPrice()
                },
                K = function (e) {
                    clearTimeout(h),
                    !P && x.parentNode && "none" != x.style.display && (h = setTimeout(H, e || 200))
                },
                T = function () {
                    if (!S) for (var e, t = f.length; t--;) e = f[t],
                    e.doUpdate(K)
                },
                E = function () {
                    if (clearInterval(l), !isNaN(a.rate)) {
                        var e = 1e3 * a.rate;
                        e > 0 && (l = setTimeout(E, e))
                    }
                    T()
                };
            this.mM = new
            function () {
                    var n = function (a, i, o) {
                        ...
                        switch (i) {
                        case "price":
                            if (l = s, c = "initPt", t.isObj(a)) a.name && "TZY" === String(a.name).toUpperCase() && (g = .2);
                            else if (t.isArr(a)) for (var h, d = a.length; d--;) if (h = a[d], h && h.name && "TZY" === String(h.name).toUpperCase()) {
                                g = .2;
                                break
                            }
                            break;
                        ...
                        i = function (t) {
                            return o ? (U ? (U.sh(t), (t.from || t.to) && U.dateFromTo(t.from, t.to)) : (e.initRs(), i(t), O.appendChild(U.getBody())), void j.resizeAll(!0)) : void KKE.api("plugins.rangeselector.get", null, function (e) {
                                o = e,
                                i(t)
                            })
                        };
            ...
            function () {
                    ...
                    this.historyT = function () {
                            if ("CN" === t.market(e.symbol)) {
                                ...
                                var n = e.datas[s];
                                if (n) {
                                    if (n.date.getFullYear() < 2008) return void Y.showTip({
                                        txt: _.historyt08,
                                        parent: x
                                    });
            ...
            var $ = function () {
                ...
                W = function (t, n, a, i, o) {
                    if (!a && z.resetX(), !(n - t < L.PARAM.minCandleNum || n > V.dataLength || 0 > t || n - t > L.PARAM.maxCandleNum)) {
                        V.start = t,
                        V.end = n,
                        V.currentLength = n - t;
                        for (var s, r = f.length, l = 0; r > l; l++) s = f[l],
                        s.setRange(i);
                        y(),
                        N(),
                        o || q.onRange(e, r > 1)
            ...
            this.compare = function (e) {
                    for (var n = e.callback, a = f.length; a--;) if (f[a].symbol == e.symbol) return void(t.isFunc(n) && n({
                        code: 1,
            ...
            this.removeCompare = function (e, t) {
                    for (var n, a, i = !1, o = e.length; o--;) {
                        a = e[o];
                        for (var s = f.length; s--;) if (a == f[s].symbol) {
                            i = !0,
                            n = f.splice(s, 1)[0],
                            n.clear(t),
                            n = null;
            ...
            this.pushData = function (e, t) {
                    ...
                    for (var a = e.length; a--;) for (var i = f.length; i--;) if (f[i].symbol === e[a].symbol && e[a].data) {
                        ee++,
                    ...
                    if (n) {
                        ...
                        for (var a = n.length; a--;) {
                            ...
                            if (i.hasOwnProperty("symbol")) {
                                for (var o = i.symbol, s = f.length; s--;) if (f[s].symbol == o) {
                                    f[s].setLineStyle(i),
                                    f[s].draw();
                                    break
                                }
                            } else e.setLineStyle(i),
                            e.draw()
                        }
                    } else e.setLineStyle(),
                    e.draw()
            ...
            var ae = -1,
                ...
                oe = function (e, t) {
                    ...
                    if (Math.abs(o) > L.PARAM.zoomLimit && (o = i * L.PARAM.zoomLimit), L.custom.centerZoom) {
                            var s = t ? t.layerX / L.DIMENSION.w_k : .5;
                            s < L.PARAM.zoomArea ? a = Math.min(a - o * Math.abs(o), V.dataLength) : s > 1 - L.PARAM.zoomArea ? n = Math.max(n + o * Math.abs(o), 0) : (n = Math.max(n + o * Math.abs(o), 0), a = Math.min(a - o * Math.abs(o), V.dataLength))
            ...
            this.moveApi = function (e) {
                    ...
                    t += e,
                    n += e,
                    n > V.dataLength && (n = V.dataLength, t = V.start + n - V.end),
            ...
            this.getExtraData = function (n) {
                    if (n = p({
                        ...
                        name: null,
                        clone: !0
                    }, n || {}), !n.name) return null;
                    for (var a, i, o = f.length; o--;) if (f[o].symbol === n.symbol) {
                        a = f[o];
                        break
                    }
                    if (a) {
                        var s;
                        "currentK" == n.name ? (s = a.kDb.get(), i = n.clone ? t.clone(s, null) : s) : (s = a.extraDataObj[n.name], i = n.clone ? t.clone(s, null) : s)
                    }
                    return i
                },
            this.updateDataAll = E,
            this.outputNewRange = D,
            this.dcReset = function () {
                    clearInterval(l),
                    clearTimeout(h);
                    for (var e, t = f.length; t--;) e = f.splice(t, 1)[0],
                    e.clear(),
                    e = null
                },
        ...
        !
        function () {
            if (!a.symbol && (a.symbol = "sh000001"), a.symbol = String(a.symbol), a.rawSymbol = String(a.symbol), a.symbol = "LSE" === t.market(a.symbol) ? t.strUtil.replaceStr(a.symbol) : a.symbol.replace(".", "$"), L = e.getSetting(["_", a.symbol, "_", Math.floor(1234567890 * Math.random() + 1) + Math.floor(9876543210 * Math.random() + 1)].join("")), 0 == location.protocol.indexOf("https:") && (a.ssl = !0), isNaN(a.rate) && (a.rate = L.PARAM.updateRate), !isNaN(a.mincandlenum) && a.mincandlenum > 0 && (L.PARAM.minCandleNum = a.mincandlenum), !isNaN(a.candlenum) && a.candlenum >= L.PARAM.minCandleNum && (L.PARAM.defaultCandleNum = a.candlenum), isNaN(a.maxcandlenum) || (L.PARAM.maxCandleNum = a.maxcandlenum), !isNaN(a.zoomunit) && a.zoomunit > L.PARAM.minCandleNum && (L.PARAM.zoomUnit = a.zoomunit), !isNaN(a.zoomlimit) && a.zoomlimit > 0 && (L.PARAM.zoomLimit = Math.round(a.zoomlimit)), g.noH5) {
                if ("undefined" == typeof FlashCanvas || a.fh5) return void(t.isFunc(a.noh5) && a.noh5(a));
                L.PARAM.isFlash = !0
            }
            if (L.PARAM.isFlash && (L.COLOR.F_BG = "#fff"), a.reorder || (L.custom.indicator_reorder = !1), a.reheight || (L.custom.indicator_reheight = !1), a.dim) for (var n in a.dim) a.dim.hasOwnProperty(n) && t.isNum(L.DIMENSION[n]) && (L.DIMENSION[n] = a.dim[n])
        }();
        var A, I, x, R, C, D, H, O, K, T, E, U, F, P = !1,
            $ = 0,
            V = {
                ...
                this.onViewPrice = function (i, o, s, r, l, c) {
                    if (!P && t.isFunc(a.onviewprice)) {
                        ...
                        if (!s) {
                            ...
                            for (var h, d, u, p, m = A.getAllStock(), f = 0, v = m.length; v > f; f++) p = m[f],
                            h = p.datas,
                            !h || h.length <= o || (d = p.getName(), u = h[o], !r && m[f].isMain && (r = h), n.push({
                                name: d,
                                data: u,
                                rangedata: h,
                                symbol: p.symbol,
        ...
        function () {
                var e, n, i, o, s, r = 37,
                    h = function (e, t, n) {
                        ...
                        for (var o, s = O.clientHeight || 0, r = H.clientHeight || 0, l = L.DIMENSION.getOneWholeTH(), c = 0, h = H.childNodes, d = h.length, u = 0, p = h.length; p--;) o = h[p],
                        o.id.indexOf("blankctn") >= 0 ? (c = o.offsetHeight, d--, u += c) : u += l;
                        return !isNaN(n) && (r -= n),
                        r / (t - s) > 1 && (r = u, i = !0),
                        L.DIMENSION.setStageW(e),
                        1 == $ ? d > 0 && (L.DIMENSION.setStageH(t, d * l + c + s), i = !0, $ = 0) : L.DIMENSION.setStageH(t, r + s),
                        i
                    },
                    d = function () {
                    ...
                    v = function () {
                        I = l(a.domid) || a.dom,
                        I || (I = c("div"), document.body.appendChild(I)),
                        x = c("div"),
                        x.style.position = "relative",
                        x.style.outlineStyle = "none",
                        x.style.webkitUserSelect = x.style.userSelect = x.style.MozUserSelect = "none",
                        R = c("div", "mainarea_" + L.uid),
                        C = c("div"),
                        R.appendChild(C),
                        D = c("div"),
                        D.style.position = "absolute",
                        D.style.fontSize = D.style.lineHeight = L.STYLE.FONT_SIZE + "px",
                        D.style.width = "100%",
                        R.appendChild(D),
                        x.appendChild(R),
                        H = c("div"),
                    ...
                    b = function (e) {
                        ...
                        if (e) {
                            U && (n = U.setTheme(e));
                            for (var a in e) e.hasOwnProperty(a) && L.COLOR.hasOwnProperty(a) && L.COLOR[a] !== e[a] && (L.COLOR[a] = e[a], n = !0);
                            t.stc("k_thm", e)
                        }
                    ...
                    y = function (e) {
                        !L.custom.mousewheel_zoom || document.activeElement !== x && document.activeElement.parentNode !== x || (A && A.onWheel(e), u.preventDefault(e), u.stopPropagation(e))
                    },
                    k = function (e) {
                        L.custom.keyboard && A && A.onKb(e)
                    },
                    M = function () {
                        t.xh5_deviceUtil.istd || (g.info.name.match(/firefox/i) ? u.addHandler(x, "DOMMouseScroll", y) : u.addHandler(x, "mousewheel", y), x.tabIndex = 0, u.addHandler(x, "keyup", k), u.addHandler(x, "keydown", k))
                    },
                    S = function (e) {
                        s = e,
                        x.appendChild(e)
                ...
                this.innerResize = function (e) {
                        A && (h(0 / 0, 0 / 0, e), A.onResize(), B.onResize(), m(), q.onInnerResize({
                            height: L.DIMENSION.h_k
                        }))
                    },
                this.initTheme = b,
            ...
            B = new
        function () {
                var e, n, i, o, s = t.market(a.symbol),
                    r = /^forex|^HF/.test(s),
                ...
                function () {
                        var t = function (t) {
                            var n = e.body.style;
                            t && L.custom.show_floater ? (n.backgroundColor = L.COLOR.F_BG, n.color = L.COLOR.F_T, n.border = "1px solid " + L.COLOR.F_BR, n.display = "") : n.display = "none"
                        };
                        this.pv = function (n) {
                            var a = e.body.style,
                    ...
                    f = function () {
                        function a() {
                            var e, n, a = "border:0;font-size:100%;font:inherit;vertical-align:baseline;margin:0;padding:0;border-collapse:collapse;border-spacing:0;text-align:center;",
                                i = "font-weight:normal;border:0;height:16px;text-align:center",
                                o = "text-align:left;font-weight:normal;border:0;height:16px;padding:0",
                            ...
                            b.innerHTML = "\u6da8\u8dcc";
                            var R = c("span");
                            if (g.style.cssText = s, v.appendChild(b), g.appendChild(R), f.appendChild(v), f.appendChild(g), w.appendChild(f), !r) {
                                    f = c("tr"),
                                    v = c("th"),
                                    v.style.cssText = o,
                                    g = c("td"),
                            ...
                            this.setFloaterData = function (a) {
                                    if (e = a.name || a.symbol || e || "", k.innerHTML = e, T = a.data || n) {
                                        n = T,
                                        E = a.stock || E;
                                        var i = E.market,
                                            o = "";
                                        ...
                                        A.innerHTML = u.toFixed(v) + F(u, f, v),
                                        I.innerHTML = p.toFixed(v) + F(p, f, v),
                                        x.innerHTML = h.toFixed(v) + F(h, f, v),
                                        s = isNaN(s) || !isFinite(s) ? "--" : (100 * s).toFixed(2),
                                        R.innerHTML = T.change.toFixed(v) + "(" + s + "%)";
                                        var g = isNaN(T.ampP) ? "--" : (100 * T.ampP).toFixed(2);
                                        if (T.ampP === 1 / 0 && (g = "--"), H.innerHTML = T.amplitude.toFixed(v) + "(" + g + "%)", R.style.color = U(s, 0), S.style.color = U(c, f), A.style.color = U(u, f), I.style.color = U(p, f), x.style.color = U(h, f), r || (C.innerHTML = y(T.volume, 2) + o), D && E) {
                                                var b = E.extraDataObj.rsAmount;
                                                if (b) {
                                                    for (var N, _ = 0, w = b.length; w > _; _++) if (T.date >= b[_].date) {
                                                        N = b[_].amount;
                                                        break
                                                    }
                                                    E.hq && E.hq.isKCB && N && (N *= 100),
                                                    N && (D.innerHTML = (T.volume / N).toFixed(2) + "%")
                                                } else D.innerHTML = "--"
                                            }
                                        24 === V.viewId || 23 === V.viewId || 25 === V.viewId ? E.hq && E.hq.isKCB && (l("__floatingPostVolume").style.display = "table-row", l("__floatingPostAmount").style.display = "table-row", T.postVol ? (O.innerHTML = y(T.postVol, 0) + o, K.innerHTML = y(T.postAmt, 2)) : (K.innerHTML = "--", O.innerHTML = "--")) : (l("__floatingPostVolume").style.display = "none", l("__floatingPostAmount").style.display = "none")
                                    }
                                },
                            this.body = h,
                            this.reset = function () {
                    ...
                    v = function () {
                        function e(e) {
                            var t = c("div"),
                                ...
                                o = e.isH,
                                s = function () {
                                    if (n.style.borderStyle = "dashed", n.style.borderColor = L.COLOR.IVH_LINE, a.style.backgroundColor = L.COLOR[e.txtBgCN], a.style.color = L.COLOR[e.txtCN], o) n.style.borderWidth = "1px 0 0 0",
                                    ...
                                    a.style.padding = "1px 0";
                                        ...
                                        L.DIMENSION.getStageH() < 0 ? (i = H.clientHeight, s = i - r) : (i = L.DIMENSION.getStageH() - O.clientHeight || 0, s = L.DIMENSION.h_k),
                                        i -= r,
                                        i += L.DIMENSION.I_V_O,
                            ...
                            this.pv = function (e) {
                                    if (!isNaN(e.y) && (t.style.top = e.y + (e.oy || 0) + "px"), a.innerHTML = e.v || "", !isNaN(e.x)) {
                                        e.x < 0 && (e.x = 0);
                                        var n = e.x + (e.ox || 0),
                ...
                this.iToD = function (t, n, a) {
                        if (!t.e || !w) {
                            ...
                            if (0 > v ? v = 0 : v >= m && (v = m - 1), !isNaN(v) && (k = v), isNaN(s) && isNaN(l)) return N = !1,
                            g(),
                            b(Number.MAX_VALUE),
                            void q.onViewPrice();
                            N = V.end != V.dataLength ? !0 : m - 1 > v;
                            for (var y, M, x, R, H, O, K, T = Number(t.mark); D.length;) D.length--;
                            if (n) {
                                    var E = A.getAllStock(),
                                        U = E.length,
                                        F = U > 1 || "percent" == L.datas.scaleType;
                                    L.custom.k_overlay && (F = !1);
                                    for (var P, $, Y, j, B = Number.MAX_VALUE, W = 0; U > W; W++) Y = E[W],
                                    H = Y.datas,
                                    !H || H.length <= v || (P = Y.getName(), $ = H[v], D.push({
                                            name: P,
                                            data: $,
                                            rangedata: H,
                                            symbol: Y.symbol,
                                            color: Y.getLineStyle().linecolor
                                        }), $.isFake || (j = Math.abs($.cy - l), B > j && (B = j, R = Y, x = $, K = H, M = P, y = R.symbol)));
                                    if (F) O = 100 * T,
                                    O = Math.abs(O) > 999 ? Math.floor(O) : O.toFixed(2),
                                    O += "%";
                                    else if (O = T > 99999 ? Math.floor(T) : T.toFixed(T > 9999 ? 1 : d), L.custom.show_k_rangepercent && R) {
                                            var G = (T - R.prevclose) / R.prevclose * 100;
                                            G = isNaN(G) || !isFinite(G) ? "--" : G.toFixed(d),
                                            O += "<br/>" + G + "%"
                                        }
                                } else {
                                    if (R = A.getMainStock(), H = R.datas, !H || H.length <= v) return;
                                    x = H[v],
                                    K = H,
                                    M = R.getName(),
                                    y = R.symbol;
                                    ...
                                    D.push({
                                        ...
                                        rangedata: K,
                                        symbol: y,
                                        color: R.getLineStyle().linecolor
                                    })
                                }
                            if (x) {
                                    var Z = s;
                ...
                this.iToKb = function (e, t) {
                        ...
                        if (w = !0, k += e, !h(R, B.iHLineO.body) && R.appendChild(B.iHLineO.body), K = A.getMainStock(), F = K.getName(), U = K.datas, !U) return void 0;
                        if (0 > k) return k = 0,
                        -1;
                        if (k >= U.length) return k = U.length - 1,
                        1;
                        var n = U[k];
                        if (!n) return void 0;
                        var a = {
                ...
                this.globalDragHandler = function (e, t, n, a, i) {
                        if (isNaN(e) && isNaN(t)) return P = 0 / 0,
                        M = !1,
                        ...
                        if (Math.abs(l) < h) {
                                ...
                                s >= c && (s = c, o = s - r),
                                0 > o && (o = 0, s = r),
                                (V.start != o || V.end != s) && (z.resetX(0), V.movY = a - n, A.moving(o, s, !0), M = !0)
                            }
                    },
                this.shortClickHandler = function () {
                        q.shortClickHandler()
                ...
                this.zoomView = function (e, t) {
                        ...
                        if (Math.abs(o) > L.PARAM.zoomLimit && (o = n * L.PARAM.zoomLimit), L.custom.centerZoom) {
                                var s = Math.min.apply(Math, t),
                                    r = s / L.DIMENSION.w_k,
                                    l = Math.max.apply(Math, t),
                                    c = l / L.DIMENSION.w_k;
                                r < L.PARAM.zoomArea ? i = Math.min(i - o * Math.abs(o), V.dataLength) : c > 1 - L.PARAM.zoomArea ? a = Math.max(a + o * Math.abs(o), 0) : (a = Math.max(a + o * Math.abs(o), 0), i = Math.min(i - o * Math.abs(o), V.dataLength))
        ...
        function () {
                ...
                var n, a = function (n, a) {
                    if (L.hasOwnProperty(n)) {
                        for (var i in a) if (a.hasOwnProperty(i) && t.isFunc(a[i])) return;
                        "DIMENSION" == n && ($ = 1),
                        p(L[n], a),
                        t.stc(n, a),
                        e.resize()
                    ...
                    i = function (e, n) {
                        ...
                        if (L.hasOwnProperty(e)) {
                            a = t.clone(L[e], null);
                            for (var i in a) if (a.hasOwnProperty(i)) if (t.isFunc(a[i])) a[i] = null,
                            delete a[i];
                            else if (n) for (var o = n.length; o--;) typeof a[i] === n[o] && (a[i] = null, delete a[i])
                        }
                        return a
                    },
                    o = function (e, t, n) {
                        ...
                        n.toremove ? A.mM.removeAC(t, e) : n.isexclusive ? (A.mM.removeAC(null, e), A.mM.newAC(t, e, n)) : A.mM.newAC(t, e, n)
                    };
                ...
                this.pushTr = function (e) {
                        if (e && e.data) {
                            for (var t, n = e.data.split(","), a = e.symbol, i = e.market, o = 0, r = n.length; r > o; o++) t = {
                                symbol: a,
                                data: n[o],
                                market: i
                            },
                ...
                this.hide = function (e) {
                        P = !0,
                        B.hideIUis(),
                        t.$CONTAINS(I, x) && I.removeChild(x),
                        e && A.dcReset()
                    },
                this.show = function (e) {
                        P = !1,
                        e && (t.isStr(e) && (e = l(e)), I = e),
                        t.$CONTAINS(I, x) || (I.appendChild(x), j.resizeAll(!0)),
                        A.outputNewRange(!0),
                        q.onViewPrice()
                    };
                var u = 0,
                    ...
                    N = function () {
                        for (var e, t = A.getMainStock().symbol, n = A.getMainStock().market, a = A.getAllStock(), i = a.length; i--;) {
                            ...
                            if (o != t) {
                                var s = e.market;
                                s != n && ("US" == s || "US" == n || "HK" == s || "HK" == n || "OTC" == s || "OTC" == n || "option_cn" == s || "option_cn" == n) && (v.push(e), g.push(o))
                            }
                        }
                    ...
                    k = function (e) {
                        "mink" == _.URLHASH.gt(e).type ? (V.viewId = e, f(), N()) : (e += u, V.viewId = e, f(u), y())
                    },
                    M = new
                function () {
                        this.isClMode = !1,
                ...
                this.showYTD = function (e, n) {
                        C = !! e,
                        B.hideIUis(),
                        m || (m = !0, this.setLineStyle({
                            linetype: "line",
                            linecolor: {
                                K_CL: L.COLOR.T_P
                            }
                        }, !0), !C && this.showScale("percent"), A.mM.togglePt({
                            v: !1,
                            ytd: !0
                        })),
                        f(u),
                ...
                this.setReK = function (e) {
                        if (e = parseInt(e), !(isNaN(e) || Math.abs(e) > 1)) {
                            ...
                            "-1" == a && (a = "_1"),
                            t.suda("k_re", "k_re" + a),
                            "mink" != n.type && (m ? this.showYTD(C, !0) : this.showView(n.baseid, void 0, !0))
                        }
                    };
                var D = function (e) {
                        var n;
                ...
                this.compare = function (e, n) {
                        if (n) {
                            for (var a = D(e), i = a.length; i--;) for (var o = g.length; o--;) if (a[i] == g[o]) {
                                g.splice(o, 1),
                                v.splice(o, 1);
                                break
                            }
                ...
                this.showPCharts = function (e) {
                        e && (A.mM.togglePt(e), t.stc("k_sp", e))
                    },
                ...
                this.dateFromTo = function (e, n, a) {
                        U && (U.dateFromTo(e, n, a), t.stc("k_ft", [e, n, a]))
                    },
                ...
                this.newSymbol = function (e) {
                        if (B.hideIUis(), B.iReset(), A.dcReset(), A.dcInit(e), Y.hideTip(), T) {
                            var n = T.getLog();
                            T = null,
                            n && this.tCharts(n)
                        }
                        ...
                        z && (z.from = void 0, z.to = void 0, A.mM.showRs(z)),
                        A.h5tM.resetHisT(),
                        t.stc("k_ns", e)
                    },
                ...
                this.getCurrentRange = function () {
                        for (var e, t, n, a = [], i = A.getAllStock(), o = 0, s = i.length; s > o; o++) n = i[o],
                        t = n.getName(),
                        e = n.datas,
                        a.push({
                            name: t,
                ...
                this.move = function (e) {
                        e = parseInt(e),
                        isNaN(e) || (A.moveApi(e), t.stc("k_move", e, 9e3))
                    },
                this.update = function () {
                        A.updateDataAll(),
                        t.stc("k_up", 9e3)
